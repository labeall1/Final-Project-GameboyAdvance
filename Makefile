...
SOURCES            = main.c myLib.c splash.c game.c instructions.c pause.c lose.c hooks.c sea.c update.c drawing.c sprites.c instructions2.c instructions3.c backgroundSong.c laugh.c
